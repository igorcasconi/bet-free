...
const { POST } = await import("@/app/api/sync/matches/route");
...
describe("POST /api/sync/matches", () => {
  ...
  it("returns 409 when a sync is already running", async () => {
    syncMatchesMock.mockRejectedValue(
